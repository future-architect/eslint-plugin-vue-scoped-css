...
| [vue-scoped-css/require-v-deep-arguments](https://future-architect.github.io/eslint-plugin-vue-scoped-css/rules/require-v-deep-arguments.html) | require selector arguments to be passed to `::v-deep()`. | :wrench: |
